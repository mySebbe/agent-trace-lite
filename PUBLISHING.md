...
1. Create the GitHub repository at `https://github.com/mySebbe/agent-trace-lite`.
2. Create the PyPI project named `agent-trace-lite`.
3. In PyPI, add a Trusted Publisher for:
   - Owner: `mySebbe`
   - Repository: `agent-trace-lite`
